...
var $querySql;
/* Metodo constructor */
function ConnectionDB($ruta_raiz, $bdOLD = true){
	...
	if ($bdOLD == true) {
		...
		// $servicio="orfeo6db_tenjo";
		// $usuario="orfeo6usr";
		// $contrasena="Oovaizoogh3t";

		$driver = "postgres";                // Tipo BD: postgres, oci8, mssql, mysql
		$servidor="127.0.0.1";                 // Mejor direccion que localhost
		$servicio="orfeodb_old";
		$usuario="orfeo6usr";
		$contrasena="eu0shahnoo1T";

		$driver	 	= $driverOLD;
		$servidor	= $servidorOLD;
