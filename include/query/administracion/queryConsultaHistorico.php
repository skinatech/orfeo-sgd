...
switch ($db->driver) {
    case 'mssql':
        $isql = "select 
                    DISTINCT (h.SGD_USH_FECHEVENTO)  AS FECHA
		...
		from 
                    ...
                    usuario u
		where 
                    h.SGD_USH_ADMCOD = u.usua_codi 
                    AND  h.SGD_USH_ADMDEP = u.depe_codi	
                    AND d.depe_codi = h.SGD_USH_ADMDEP 
                    AND h.SGD_USH_MODCOD = m.SGD_USM_MODCOD 
                    AND H.SGD_USH_USULOGIN = " . "'" . $usuLogin . "'" .
