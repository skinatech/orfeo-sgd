...
switch($db->driver)
{
	...
	case 'mysql':
	{
		$isql = 'select
					...
					UPPER(b.RA_ASUN)  as "Asunto",
					c.SGD_TPR_DESCRIP as "Tipo Documento",
					(agen.SGD_AGEN_FECHPLAZO-'.$db->conn->sysDate.') as "Dias Restantes Agenda",
	...
	case 'ocipo':
	{
		$isql = 'select
				...
				UPPER(b.RA_ASUN)  as "Asunto",
				c.SGD_TPR_DESCRIP as "Tipo Documento",
				round(agen.SGD_AGEN_FECHPLAZO-sysdate) as "Dias Restantes Agenda",
