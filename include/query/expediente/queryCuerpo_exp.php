...
switch ($db->driver) {
    case 'mssql':
        ...
        $isql = "select distinct d.sgd_exp_numero as sgd_exp_numero ,
                        d.sgd_exp_estado,
                        a.radi_path,
                        d.RADI_NUME_RADI as RADI_NUME_RADI,
                        a.RADI_NUME_HOJA,
                        a.RADI_FECH_RADI,
                        a.RADI_NUME_RADI as RADI_NUME_RADI,
                        a.RA_ASUN  ,
                        a.RADI_PATH ,
                        a.RADI_USUA_ACTU ," .
                $sqlfecha . " AS FECHA ,
        ...
        $isqlCount = "select count(*) REGS
			...
			";
        if ($estado == 2)
            $isqlCount .= " and d.SGD_EXP_FECH_ARCH !='' ";
	...
	r.radi_nume_radi like '$data' and m.sgd_tpr_codigo=r.tdoc_codi";
        ...
        break;
    case 'mysql':
        $redondeo = "(DAYOFWEEK(radi_fech_radi-" . $db->conn->sysTimeStamp . ")+floor(b.sgd_tpr_termino * 7/5)+(select count(*) from sgd_noh_nohabiles where NOH_FECHA between a.RADI_FECH_RADI and " . $db->conn->sysTimeStamp . "))";
