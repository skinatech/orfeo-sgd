...
switch ($db->driver) {
    case 'mssql':
        $isql = "select  convert(char(19), r.RADI_NUME_GRUPO) as RADI_NUME_GRUPO
	                  , count(*) as DOCUMENTOS
	                  , min(convert(char(19),r.RADI_NUME_SAL)) as RAD_INI
	                  , MAX(convert(char(19),r.RADI_NUME_SAL)) as  RAD_FIN 
					  , $sqlFecha AS FECHA  
						, USUA_DOC
						,rd.TDOC_CODI 
