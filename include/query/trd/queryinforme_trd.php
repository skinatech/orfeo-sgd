...
switch ($db->driver) {
    ...
    case 'mysql': {
             ...
             * CONSERVACION TOTAL (1), ELIMINACION (2), SELECCION (4), se agrega las opciones MEDIO TECNOLOGICO (3), CONSERVACION TOTAL/MEDIO MAGNETICO (5), *     * ELIMINACION/MEDIO TECNOLOGICO (6) Y MEDIO TECNOLOGICO/SELECCION (7)                                                                           *
             * ********************************************************************************************************************************************** */
