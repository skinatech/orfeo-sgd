...
if (!function_exists('str_split')) {
	 ...
	 */
	function str_preg_split($string, $split_length=1) {
...
class QRcode {
	 ...
	 */
	 protected function eatNum() {
		...
		$this->items = $this->appendNewInputItem($this->items, QR_MODE_NM, $run, str_preg_split($this->dataStr));
		return $run;
	}
	 ...
	 */
	 protected function eatAn() {
		...
		$this->items = $this->appendNewInputItem($this->items, QR_MODE_AN, $run, str_preg_split($this->dataStr));
		return $run;
	}
	 ...
	 */
	 protected function eatKanji() {
		...
		$this->items = $this->appendNewInputItem($this->items, QR_MODE_KJ, $p, str_preg_split($this->dataStr));
		return $run;
	}
	 ...
	 */
	 protected function eat8() {
		...
		$run = $p;
		$this->items = $this->appendNewInputItem($this->items, QR_MODE_8B, $run, str_preg_split($this->dataStr));
		return $run;
	}
