    ...
    class QRtools {
        ...
        public static function tcpdfBarcodeArray($code, $mode = 'QR,L', $tcPdfVersion = '4.5.037')
        {
            ...
            foreach ($qrTab as $line) {
                $arrAdd = array();
                foreach(str_preg_split($line) as $char)
                    $arrAdd[] = ($char=='1')?1:0;
 ...
 */
    ...
    class QRsplit {
        ...
        public function eatNum()
        {
            ...
            $ret = $this->input->append(QR_MODE_NUM, $run, str_preg_split($this->dataStr));
            if($ret < 0)
                return -1;
        ...
        public function eatAn()
        {
            ...
            $ret = $this->input->append(QR_MODE_AN, $run, str_preg_split($this->dataStr));
            if($ret < 0)
                return -1;
        ...
        public function eatKanji()
        {
            ...
            $ret = $this->input->append(QR_MODE_KANJI, $p, str_preg_split($this->dataStr));
            if($ret < 0)
                return -1;
        ...
        public function eat8()
        {
            ...
            $run = $p;
            $ret = $this->input->append(QR_MODE_8, $run, str_preg_split($this->dataStr));
        ...
        public static function splitStringToQRinput($string, QRinput $input, $modeHint, $casesensitive = true)
        {
            ...
            $split = new QRpreg_split($string, $input, $modeHint);
    ...
    class QRarea {
        ...
        public function __construct($source_tab) 
        {
            ...
            foreach ($source_tab as $line) {
                ...
                foreach (str_preg_split($line) as $item) {
        ...
        {
            $outArray = array();
            $symbolArray = str_preg_split($stringData);
            $last = '';
            $run = 1;
    ...
    class QRcode {
        ...
        */
        public function encodeString8bit($string, $version, $level)
        {
            ...
            $ret = $input->append(QR_MODE_8, strlen($string), str_preg_split($string));
            if($ret < 0) {
                unset($input);
                return NULL;
            }
