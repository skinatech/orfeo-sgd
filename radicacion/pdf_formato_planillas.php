...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Image('../logoEntidad_negro_pdf.jpg', 6, 10, 39);
        ...
        $this->SetY(15);
        $this->SetX(45);
        $this->Cell(248, 5, utf8_decode('NOMBRE DEL FORMATO:'), 0, 2, 'C');
        $this->SetY(20);
        $this->SetX(45);
        $this->Cell(248, 5, utf8_decode('REGISTRO DE COMUNICACIONES ENVIADAS'), 0, 2, 'C');
        $this->Cell(248, 10, utf8_decode('PROCESO DE GESTIÓN DOCUMENTAL'), 1, 2, 'C');
        $this->SetY(50);
        $this->SetX(5);
        $this->Cell(27, 5, utf8_decode('Fecha Radicado'), 'LTR', 0, 'L');
        $this->Cell(28, 5, utf8_decode('No.Radicado'), 'LTR', 0, 'L');
        $this->Cell(60, 5, utf8_decode('Remitente'), 1, 0, 'L');
        $this->Cell(60, 5, utf8_decode('Destinatario'), 1, 0, 'L');        
        $this->Cell(50, 5, utf8_decode('Asunto'), 'LTR', 0, 'L');   
        // $this->Cell(30, 5, utf8_decode('Dirección'), 1, 0, 'L');     
        $this->Cell(33, 5, utf8_decode('Fecha/Hora Entrega'), 'LTR', 0, 'L');
        $this->Cell(30, 5, utf8_decode('Firma Recibido'), 'LTR', 0, 'L');
        $this->SetY(55);
        $this->SetX(5);
        //$this->Ln();
        $this->Cell(30, 5, '' , 'LBR' , 0, 'L');
        $this->Cell(25, 5, '', 'LBR', 0, 'L');
        $this->Cell(30, 5, utf8_decode('Persona'), 1, 0, 'L');
        $this->Cell(30, 5, utf8_decode('Dirección'), 1, 0, 'L');
        $this->Cell(30, 5, utf8_decode('Persona'), 1, 0, 'L');
        $this->Cell(30, 5, utf8_decode('Dirección'), 1, 0, 'L');
        $this->Cell(50, 5, '', 'LBR', 0, 'L');   
        // $this->Cell(30, 5, utf8_decode('Dirección'), 1, 0, 'L');     
        $this->Cell(33, 5, '', 'LBR', 0, 'L');
        $this->Cell(30, 5, '', 'LBR', 2, 'L');
        $this->SetY(60);
        $this->SetX(5);
    }
