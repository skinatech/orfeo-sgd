...
if ($eMailMid != 0) {
    ...
    $iMail = 0;
        ...
        include 'generarImagenRadicado.php';
        ...
        if($attachments){
            foreach($attachments as $attachment){
                ...
                $filename = imap_utf8($attachment['filename']) ?? imap_utf8($attachment['name']);
                // echo "Archivo -->" . $filename;
                $Pid = $aid;
                
                // Nombre del archivo adjunto
                $fname =  imap_utf8($filename);
                ...
                $archivo = imap_base64($attachment['attachment']);
                fputs($file1, $archivo);
                fclose($file1);
...
include_once '../facturacionElectronica/emailRadicado.php';
