...
<table class="table table-responsive" align="center">
  ...
  <tbody>
    <tr>
      	<th scope="row">1</th>
      	<td>La versi&oacute;n de PHP debe ser 5.3 o superior</td>
...
<input type="button" value="Recargar p&aacute;gina" onClick="location.reload();" style="width: 200px; height: 30px; background: #6699FF; color: #ffffff; cursor: pointer; border: 0px;"/>
<?
