...
function creaDirDepe( $ruta_raiz ,$anoCrear)
{
    ...
    // Directorio firmas_usuarios
    // Verifica si no existe el directorio fax
    if ( ! is_dir( $ruta_raiz.'/bodega/firmas_usuarios' ) )
    {
        // Crea un directorio llamado fax
        if ( mkdir ( $ruta_raiz.'/bodega/firmas_usuarios', 0777 ) )
        {
            print "Directorio ".$ruta_raiz.'/bodega/firmas_usuarios'." creado.<br>";
        }
        else
        {
            print "No se pudo crear el directorio ".$ruta_raiz.'/bodega/firmas_usuarios.<br>';
        }
    }
}
?>
