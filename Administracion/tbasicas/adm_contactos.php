...
if ($db) {
    ...
    if (isset($_POST['btn_accion'])) {
        $record = array();
        ($_POST['hdBandera'] == 'A') ? $record['CTT_ID'] = $db->conn->nextId('SEC_DEF_CONTACTOS', $driver) : $record['CTT_ID'] = $_POST['txtidctt'];
...
if ($error) {
    ...
    switch ($error) {
        case 1: $msg .= "Informaci&oacute;n actualizada!!";
            break;             //ACUTALIZACION REALIZADA
        case 2: $msg .= "Contacto creado satisfactoriamente!!";
            break;          //INSERCION REALIZADA
        case 3: $msg .= "Error al conectar a BD, comun&iacute;quese con el Administrador de sistema !!";
            break; //NO CONECCION A BD
        case 4: $msg .= "Error al gestionar datos, comun&iacute;quese con el Administrador de sistema !!";
            break; //ERROR EJECUCCI�N SQL
        case 5: $msg .= "No se puede eliminar Contacto, se encuentra ligado a historial.";
        ...
        foreach ($array as $key => $value) {
            switch (gettype($value)) {
                ...
                case 'integer': $jsArray .= $name . '[' . valueToJsValue($key, $encoding) . '] = ' . $value . ';' . $nl;
                    break;
                default: trigger_error('Hoppa, egy j tus a PHP-ben?' . __CLASS__ . '::' . __FUNCTION__ . '()!', E_USER_WARNING);
            }
        }
        return $jsArray;
    } else {
...
<html>
    <head>
        ...
        <script language="JavaScript">
            ...
            ***/
            function validateSubmitDelete()
            {
                var confirDelete = confirm("<?= "Est&aacuote; seguro de borrar contacto?" ?>");
        ...
        <!--
            ...
            function Actual()
            {
                ...
                } else
                {
                    while (found)
                    {
                        if (vc[x]['ID'] == Obj.options[i].value)
                            break;
                x += 1;        
            }        
...
if (isset($tmp_vector) && is_array($tmp_vector))
                ...
                <table width="75%" border="1" align="center" class=t_bordeGris>
                    <tr class=timparr>
                        ...
                        <td width="72%" class="listado2" height="1">
                            <select name="idtipo" id="idtipo" class="select" onchange="document.form1.ideps.value = '';
                                this.form.submit();" title="Listado de tipos de contacto existentes">
                    ...
                    <tr class=timparr>
                        ...
                        <td width="72%" class="listado2">
                            <?php	// Listamos las entidades/Empresas.
                            if (isset($rs_idtipo))
                    ...
                    <tr>
                        ...
                        <td width="72%" class="listado2">
                            <input type="text" name="txtcargo" id="txtcargo" size="20" title="Campo para ver,ingresar o editar el cargo del contacto" maxlength="30">
                    ...
                    <tr>
                        ...
                        <td width="72%" class="listado2"><input type="text" name="txtnombre" id="txtnombre" size="20" title="Campo para ver,ingresar o editar el nombre del contacto" maxlength="30"></td>
                    </tr>
                    <tr>
                        <td class="titulos2" height="26"><label for="txttelefono">Tel&eacute;fono del contacto</label></td>
                        <td class="listado2"><input type="text" name="txttelefono" id="txttelefono" size="20" title="Campo para ver,ingresar o editar el teléfono del contacto" maxlength="30"></td>
                    </tr>
<?php
echo $msg;
?>
                ...
                <table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" class="listado2">
                    <tr class="cajaBotonesMedio">
                        ...
                        <td width="20%" class="listado1" align="center"><input name="btn_accion" type="submit" class="botones" id="btn_accion" value="Eliminar" onClick="document.form1.hdBandera.value = 'E'; return ValidarInformacion(); return validateSubmitDelete();" accesskey="E" aria-label="Eliminar el contacto seleccionado"></td>
                        <td width="10%" class="listado1">&nbsp;</td>
                    </tr>
                </table>
            </center>
