    ...
    <body bgcolor="#FFFFFF" topmargin="0" >
        <div class="container" >
            <div class="panel panel-body">
                <h3>Inactivación masiva de usuarios</h3>                
                <div class="form-group"><br>
                    Desde esta opción se puede hacer la inactivación de usaurios de forma masiva, por favor realizar los siguientes pasos:
                    <br><br>
                    &nbsp;&nbsp;&nbsp;1. Para <strong> inactivar usuarios </strong> abrir el archivo <strong><a href="<?= $entidad_contacto . $ambiente . '/bodega/tmp/usuarios_masiva_inactivar.csv' ?>">usuarios_masiva_inactivar.csv</a></strong><br>
                    &nbsp;&nbsp;&nbsp;2. Ingresar los correos electronicos de los usuarios que se van a inactivar, en el archivo anteriormente descargado.<br>
